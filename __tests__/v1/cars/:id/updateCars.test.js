...
describe('GET /v1/cars/:id', () => {
  ...
  it('should response with 401 as status code (userCustomer cannot be update car)', async () => await request(app)
  ...
  it('should response with 201 as status code sukses update cars by admin', async () => await request(app)
    .post('/v1/auth/login') // request api login
    .set('Content-Type', 'application/json')
  ...
  it('should response with 422 as status code price car invalid', async () => await request(app)
    .post('/v1/auth/login') // request api login
    .set('Content-Type', 'application/json')
    .send({ email: userAdmin.email, password }) // need email and password for login userCustomer
    .then(async (res) => {
