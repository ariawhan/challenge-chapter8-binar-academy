...
describe('GET /', () => {
  ...
  it('should response with 200 as status code (Application Start)', async () => request(app)
    .get('/')
    .then((res) => {
  ...
  it('should response with 404 as status code (Application Not found)', async () => request(app)
    .get('/Ap')
    .then((res) => {
